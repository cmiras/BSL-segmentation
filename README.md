...
This project is based on the work of Katrin Renz et al. and was done in the context of the Computer Vision and Object Recognition course of the [Master MVA](https://www.master-mva.com/).
